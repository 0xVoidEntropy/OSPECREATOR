            ...
            <div className="bg-slate-900/60 border border-slate-700/40 rounded-2xl p-6">
              ...
              <form onSubmit={handleUpload} className="space-y-4">
                ...
                <button
                  ...
                  className="press-scale w-full flex items-center justify-center gap-2 bg-violet-600 hover:bg-violet-500 disabled:opacity-50 disabled:cursor-not-allowed text-white font-semibold py-3 rounded-xl transition-colors duration-200"
                >
                  {uploading ? (
